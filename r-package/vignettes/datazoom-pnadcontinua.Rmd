...
The Continuous PNAD is a panel survey from Brazil's IBGE, in which each household is interviewed for five consecutive quarters. Despite correctly identifying the same household in all five interviews.
