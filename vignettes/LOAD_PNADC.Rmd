...
Use the table below to identify what time span to download. It shows the first and last quarter (`ANOtrimestre`, e.g.
...
\small Source: authors' calculations and IBGE's Methodological Notes on PNADC (2014).
